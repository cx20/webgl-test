// File : main.cpp
// Compile : emcc main.cpp -std=c++11 -s WASM=1 -s USE_SDL=2 -s USE_SDL_IMAGE=2  -O3 -o index.js --preload-file frog.jpg --use-preload-plugins
...
int main()
{
    ...
    SDL_Surface *image = IMG_Load("frog.jpg");
    GLuint textureID;
