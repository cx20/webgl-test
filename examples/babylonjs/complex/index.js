...
*/
        ...
        var ground1 = BABYLON.MeshBuilder.CreatePlane("ground2", {width:100, height:0.1}, scene);
        ground1.rotate(BABYLON.Axis.X, Math.PI/2, BABYLON.Space.LOCAL);
        ground1.position.x = -49.5;
        ground1.position.z = 1.6;
        
        var ground2 = BABYLON.MeshBuilder.CreatePlane("ground2", {width:100, height:0.1}, scene);
        ground2.rotate(BABYLON.Axis.X, Math.PI/2, BABYLON.Space.LOCAL);
        ground2.position.x = -49.5;
        ground2.position.z = 2.35;
        
        // Create a particle system
        var particle1 = new BABYLON.ParticleSystem("particle1", 100, scene);
        
        var texture = new BABYLON.Texture("../../../assets/textures/smokeparticle.png", scene);
        ...
        var emitterLeftBack = BABYLON.Mesh.CreateBox("emitterLeftBack", 0.1, scene);
